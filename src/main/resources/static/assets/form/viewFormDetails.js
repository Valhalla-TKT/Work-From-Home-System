$(document).ready(function () {
    ...
    function checkSelectedRadio() {
        const selectedRadio = $('#radio-button-container input[name="radio-group"]:checked');
        if (selectedRadio.length) {
            viewDetailUpdateBtn.show();
        }
    }

    $('#radio-button-container input[name="radio-group"]').on('change', function() {
        checkSelectedRadio();
    });
    ...
    function updateForm() {
        ...
        const selectedRadio = document.querySelector('#radio-button-container input[name="radio-group"]:checked');
        if (selectedRadio) {
        ...
        const data = {
            ...
            requestPercent: selectedRadio.value
        };
